...
class MLPHead(nn.Module):  # MLP Head
    ...
    def forward(self, x):
        ...
        return self.mlphead(cls), self.fc(cls)


class ViT(nn.Module):  # Vision Transformer
    def __init__(self, image_channels=3, image_size=64, num_classes=10, patch_size=4, dim=768, num_heads=12,
                 layers=4):
    ...
    def forward(self, x):
        ...
        feature,  features = self.head(feature)
        feature = torch.log_softmax(feature, dim=1)
